...
- `intunedctl platform attempts get <run-id> [attempt-number] [options]`:
...
- `intunedctl platform attempts log <run-id> [attempt-number] [options]`:
...
- `intunedctl platform attempts trace <run-id> [attempt-number] [options]`:
